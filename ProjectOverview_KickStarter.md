...
This puts Louise's campaign marketing strategy into question, as a successful campaign with **_Fever's_** average donation would be an outlier within the set of mean donation amounts for successful play campaigns ($249 is greater than 1.5*IQR+Upper Quartile of set of mean donation amounts for successful play campaigns).  A dataset to investigate how directors of successful play KickStarter campaigns sought donations (in-person, phone, email, text, etc.), the amount sought from potentional donors (suggested donation amount), and variation in mean donated amount amongst the marketing strategies employed, in addition to knowledge of Louise's promotional strategy for comparison could lay the foundation for further insights.
